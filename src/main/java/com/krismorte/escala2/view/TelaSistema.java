 ...
 * @author c007329
 */
public class TelaSistema extends javax.swing.JDialog {

    /**
     * Creates new form TelaSistema
     */
    public TelaSistema(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerador de Escalas 2.0 v1.0");
    ...
    private void btnDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatabaseActionPerformed
        TelaBancoDeDados db = new TelaBancoDeDados(null, true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSistema dialog = new TelaSistema(new javax.swing.JFrame(), true);
