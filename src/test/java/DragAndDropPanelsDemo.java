...
/**
 * <p>
 * Example of dragging and dropping panels in Java 5.</p>
 * <p>
 * Everything kept in simple class for pursposes of simplicity.</p>
 *
...
public class DragAndDropPanelsDemo extends JFrame {
    ...
    /**
     * <p>
     * This represents the data that is transmitted in drag and drop.</p>
     * <p>
 ...
 * RandomDragAndDropPanel's.</p>
 * <p>
 * You can see that this has a DropTarget associated with it!</p>
 *
 * @author besmit
 */
...
/**
 * <p>
 * Panel with random number. Can be dragged and dropped.</p>
 *
 * @author besmit
 */
...
/**
 * <p>
 * Listener that make source draggable.</p>
 * <p>
 * Thanks, source modified from:
 * http://www.zetcode.com/tutorials/javaswingtutorial/draganddrop/</p>
 */
...
/**
 * <p>
 * Used by both the draggable class and the target for negotiating data.</p>
 * <p>
...
class DragAndDropTransferHandler extends TransferHandler implements DragSourceMotionListener {
     ...
     * implements Transferable, so this requires only a type cast.</p>
     *
     * @param c
     * @return
     */
     ...
     * or neither. We are only concerned with copying.</p>
     *
     * @param c
     * @return
     */
...
/**
 * <p>
 * Listens for drops and performs the updates.</p>
 * <p>
 * The real magic behind the drop!</p>
 */
